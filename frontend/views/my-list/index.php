    ...
    <div class="main-container page-container">
        <section class="menu-toggle">
            <ul class="menu-toggle__list">
                ...
                <?php
                foreach (MyTask::FILTERS as $filter): ?>
                    ...
                    <?php
                    if ($filter === MyTask::FILTER_COMPLETED): ?>
                    ...
                    <?php
                    if ($filter === MyTask::FILTER_ACTIVE): ?>
                    ...
                    <?php
                    if ($filter === MyTask::FILTER_CANCELED): ?>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <?php
                    if ($filter === MyTask::FILTER_FAILED): ?>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="<?= Url::to(['my-list/index', 'filter' => $filter]) ?>">
                        <?= MyTask::getName()[$filter] ?>
                    </a>
                    </li>
                <?php
                    ...
                    <div class="new-task__card">
                        ...
                        <div class="feedback-card__top ">
                            <a href="<?= URL::to(['users/view', 'id' => $modelTask['customer_id']]) ?>">
                                <img src="<?= URL::to('/img/' . $modelTask['avatar']) ?>" width="36" height="36">
                            </a>
                            <div class="feedback-card__top--name my-list__bottom">
                                ...
                                <a href="<?= URL::to(['tasks/view', 'id' => $modelTask['id']]) ?>"
                                   class="my-list__bottom-chat  my-list__bottom-chat--new"><b><?= $modelTask['messages'] ?></b></a>
                                <?= str_repeat('<span></span>', $modelTask['rate']); ?>
                                <?= str_repeat('<span class="star-disabled"></span>', 5 - $modelTask['rate']); ?>
                                <b><?= $modelTask['userName'] ?></b>
                            </div>
                        </div>
                    </div>
                <?php
